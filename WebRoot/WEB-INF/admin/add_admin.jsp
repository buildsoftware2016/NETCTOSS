    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function check_code(){
            	...
            	//检查格式
            	if(reg.test(code)){
            		$("#code_msg").text("格式正确").removeClass("error_msg");
            	}else{
            		$("#code_msg").text("30长度以内的字母、数字和下划线的组合").addClass("error_msg");
            		return false;
            	}
            	...
            	$.post(
            		...
            		function(data){
            			if(data){
            				$("#code_msg").text("该管理员账号可以使用").removeClass("error_msg");
            				flag=true;
            				return true;
            			}
            			if(!data){
            				$("#code_msg").text("账号重复").addClass("error_msg");
            				return false;
            			}
            		}
            	);
            ...
            function check_pwd(){
            	...
            	//检查格式
            	if(reg.test(pwd1)){
            		$("#pwd1_msg").text("格式正确").removeClass("error_msg");
            	}else{
            		$("#pwd1_msg").text("30长度以内的字母、数字和下划线的组合").addClass("error_msg");
            		return false;
            	}
            	
            	//检查重复
            	if(pwd1==pwd2){
            		$("#pwd2_msg").text("正确,2次相同").removeClass("error_msg");
            		//flag=true;
            		return true;
            	}else{
            ...
            var timer=setInterval(function(){
            	if(check_name() && flag && check_pwd() && check_telephone() && check_email() && check_role() ){
        ...
        <div id="main">            
            ...
            <form action="addAdmin.do" method="post" class="main_form">
                    ...
                    <div class="input_info">
                        <input name="name" id="name" type="text" onblur="check_name()" />
                        <span class="required">*</span>
                        <div class="validate_msg_long" id="name_msg">20长度以内的汉字、字母、数字的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>管理员账号：</span></div>
                    <div class="input_info">
                        <input name="admin_code" id="code" type="text" onblur="check_code()"  />
                        <span class="required">*</span>
                        <div class="validate_msg_long" id="code_msg">30长度以内的字母、数字和下划线的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>密码：</span></div>
                    <div class="input_info">
                        <input name="password" id="pwd1" type="password"  />
                        <span class="required">*</span>
                        <div class="validate_msg_long" id="pwd1_msg">30长度以内的字母、数字和下划线的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>重复密码：</span></div>
                    <div class="input_info">
                        <input id="pwd2" type="password" onblur="check_pwd()" />
                        <span class="required">*</span>
                        <div class="validate_msg_long" id="pwd2_msg">两次密码必须相同</div>
                    </div>      
                    ...
                    <div class="input_info">
                        ...
                        <span class="required">*</span>
                        <div class="validate_msg_medium" id="email_msg">正确的 email 格式</div>
                    </div>
