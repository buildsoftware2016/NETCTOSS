    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function startFee(id) {
                var r = window.confirm("确定要启用此资费吗？资费启用后将不能修改，停用和删除。");
            ...
            function deleteFee(id) {
                ...
                if(r){
                	location.href='deleCost.do?cost_id='+id;
                }
                    ...
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>
                            	<c:choose>
                            		<c:when test="${c.status==0}">
                            			<font color="green">开通状态下不能修改，停用或删除</font>
                            		</c:when>
                            		<c:otherwise>
                            			<input type="button" value="启用" class="btn_start" onclick="startFee(${c.cost_id});" />
                                		<input type="button" value="修改" class="btn_modify" onclick="location.href='toModiCost.do?cost_id=${c.cost_id}';" />
